...
namespace Ethanzway\JWT\Test\Storage;

use Mockery;
use Ethanzway\JWT\Test\AbstractTestCase;
use Illuminate\Contracts\Cache\Repository;
use Ethanzway\JWT\Test\Stubs\TaggedStorage;
use Ethanzway\JWT\Storage\Illuminate as Storage;
...
class IlluminateTest extends AbstractTestCase
{
    ...
    /**
     * @var \Ethanzway\JWT\Storage\Illuminate
     */
    protected $storage;
    ...
    private function emulateTags()
    {
        ...
        $this->cache->shouldReceive('tags')->with('jwt')->once()->andReturn(Mockery::self());
    }
