...
use Ethanzway\JWT\Claims\Audience;
...
{
    /**
     * @var \Mockery\MockInterface|\Ethanzway\JWT\Validators\PayloadValidator
     */
    protected $validator;

    /**
     * @var \Ethanzway\JWT\Payload
     */
    protected $payload;
    ...
    /**
     * @test
     * @expectedException \Ethanzway\JWT\Exceptions\PayloadException
